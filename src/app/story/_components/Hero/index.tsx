...
const Hero: React.FC = () => {
  return (
    <Container className="bg-ginger-700 pb-6 pt-48 md:pb-20 md:pt-60">
      ...
      <h1 className="mx-auto w-full text-center font-gothic text-3xl/tight font-bold text-white md:w-8/12 md:text-6xl/tight">
      ...
      <div className="relative mb-[7.5rem] mt-10">
        ...
        <Sticker className="absolute -right-[3%] -top-[7%] w-[24vw] md:right-[3.5%] md:top-[3.5%] md:w-[11.5rem]" />
      </div>
